...
function show_warning(id) {
    setHTMLElemStyle('display', 'block', 'warning_could_not_enter_AR', false);
    setHTMLElemStyle('display', 'block', id, false);
    registerSetTimeout(3, function() {
        setHTMLElemStyle('display', 'none', 'warning_could_not_enter_AR', false);
...
addHTMLElement('img', 'Enter_AR_image', 'TO', 'Enter_AR_Button', false);
setHTMLElemAttribute('src', 'media/enter_AR_button.png', 'Enter_AR_image', false);

createCSSRule('.warning-center', "position: absolute; width: 100%; height: 50px; top: 50%; margin-top: -25px; left: 0; display: block;", false, '');
...
createCSSRule('.info-button', "position: absolute; width: 50px; height: 50px; z-index: 1; top: 10px; right: 10px; color: #000000; background-repeat: no-repeat; display: block; overflow: hidden; border-style: none; border-color: #000000; cursor: pointer;", false, '');
addHTMLElement('a', 'info_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'info-button', 'info_button', false);
setHTMLElemAttribute('href', 'https://ved.com', 'info_button', false);
...
setHTMLElemAttribute('src', 'media/warning_AR_unavailable.png', 'waning_AR_unavailable_img', false);

changeVis(['GROUP', 'indicator_group'], false);
changeVis(['prompt_move_around', 'ready_button', 'edit_button', 'drag_move', 'drag_scale', 'drag_rotate', 'scale_percentage'], false);
operateAnimation('PLAY', 'Ved_armature', 0, 114, 'LoopRepeat', 1, function() {}, false);

volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('Vedsbody', false, false, [0,1,2], false, function(event) {
    operateAnimation('STOP', 'Ved_armature', null, null, 'AUTO', 1, function() {}, false);
    playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);
    operateAnimation('PLAY', 'Ved_armature', 116, 140, 'LoopOnce', 1, function() {
        operateAnimation('PLAY', 'Ved_armature', 0, 114, 'LoopRepeat', 1, function() {}, false);
    }, false);
}, function(event) {});
...
checkARMode(function() {
    eventHTMLElem('pointerup', 'Enter_AR_Button', false, function(event) {
        enterARMode('ORIGIN', true, function() {
            changeVis(['GROUP', 'Veds group'], false);
            ...
            changeVis(['GROUP', 'Veds group'], true);
            changeVis('prompt_move_around', false);
            setObjTransform('Ved_armature', false, 'position', createVector(0, 0, 0), false);
            setHTMLElemStyle('display', 'block', 'Enter_AR_Button', false);
            changeVis(['drag_move', 'drag_rotate', 'ready_button', 'drag_scale', 'scale_percentage', null], false);
            setObjTransform('Ved_armature', false, 'position', [1, 1, 1], false);
    ...
    setHTMLElemAttribute('href', exportToUSDZ('Vedsbody'), 'Enter_AR_Button', false);
    setHTMLElemAttribute('rel', 'ar', 'Enter_AR_Button', false);
    setHTMLElemAttribute('download', 'ved.usdz', 'Enter_AR_Button', false);
}, function() {
    eventHTMLElem('pointerup', 'Enter_AR_Button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], false, function(event) {
    changeVis(['GROUP', 'Veds group'], true);
    setObjTransform('Ved_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
    setObjDirection('Ved_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
    changeVis(['scale_percentage', 'ready_button', 'edit_button', 'drag_move', 'drag_scale', 'drag_rotate'], false);
    changeVis(['GROUP', 'indicator_group'], false);
}, function(event) {});
...
registerOnDrag('drag_move', false, [0,1,2], function(event) {}, function(event) {
    dragMoveAdv('Ved_armature', 'XY', 'WORLD', '5{[,[fMnO8$BjKs,q_.4', '2+C%Dp1DA#7^`V:bQ7~q');
}, function(event) {}, '2+C%Dp1DA#7^`V:bQ7~q');

registerOnDrag('drag_rotate', false, [0,1,2], function(event) {}, function(event) {
    dragRotateAdv('Ved_armature', 'Z', 'WORLD', 'rdYYXraIrM`GE:;|i5h-', 't%elWAAsk{p-jX%68sP`');
}, function(event) {}, 't%elWAAsk{p-jX%68sP`');

registerOnDrag('drag_scale', false, [0,1,2], function(event) {}, function(event) {
    dragScale('Ved_armature', 'Z', 'rN=nj*RAF)wCkB/MWD;s', '1CCRZg)KaE~T%drKAKOm');
    dragScale('Ved_armature', 'X', '7Yw$]acQyfXI(Y/_5^*#', '1CCRZg)KaE~T%drKAKOm');
    dragScale('Ved_armature', 'Y', '3|Lxt=HEP5|!at1$qza#', '1CCRZg)KaE~T%drKAKOm');
    updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('Ved_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function(event) {}, '1CCRZg)KaE~T%drKAKOm');
